    ...
    <div className="pt-20 pb-32">
      ...
      <section className="px-6 max-w-4xl mx-auto mb-40">
        <motion.div 
          ...
          variants={fadeInUp}
        >
          <div className="text-primary text-xs font-bold uppercase tracking-widest mb-6">Perspective</div>
          <h1 className="text-5xl md:text-7xl font-serif font-bold mb-16 tracking-tight text-foreground">Founder’s Note</h1>
          
          <div className="space-y-8 text-lg md:text-xl text-muted-foreground leading-relaxed font-light">
            <p>
              <span className="text-foreground font-medium">Millennium Automation was founded on a simple belief:</span> manufacturing deserves technical leadership that is practical, principled, and built for the long term — not more abstraction, but better execution.
            </p>
            <p>
            ...
            <p className="text-foreground font-medium italic border-l-2 border-primary pl-6 py-2 my-8">
      ...
      {/* Approach Section */}
      <section className="bg-secondary/20 py-32 border-t border-border">
        <div className="px-6 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 mb-24">
            <motion.div
               ...
               transition={{ duration: 0.6 }}
            >
              <h2 className="text-4xl md:text-6xl font-serif font-bold mb-8">Our Approach</h2>
              <p className="text-3xl font-serif italic text-primary mb-8">Engineers first. Responsibility always.</p>
            </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {principles.map((principle, index) => (
              <motion.div 
                ...
                className="bg-card border border-border p-8 md:p-12 rounded-lg hover:border-primary/40 transition-colors group"
              >
                <div className="flex items-start gap-6">
                  <div className="text-5xl font-serif font-bold text-secondary-foreground/20 group-hover:text-primary/20 transition-colors">
                    0{index + 1}
                  </div>
